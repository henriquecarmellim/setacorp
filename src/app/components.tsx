...
export function Testimonials() {
  return (
    <section id="testimonials" className="bg-gray-100 py-10 md:py-20 lg:py-32">
      <div className="container mx-auto px-4 md:px-8 lg:px-12">
        <div className="text-center mb-8">
          <div className="inline-block bg-gray-200 px-3 py-1 rounded-full text-sm font-medium mb-2 text-black">
            Depoimentos
          </div>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-black">O Que Nossos Clientes Dizem</h2>
        </div>
...
export const testimonialsData = [
    ...
    },
    {
      ...
      "position": "Gerente de TI, Stark Industries",
      "avatar": "/avatar1.png",
      "testimonial": "A equipe da Seta Corp entregou consistentemente soluções de alta qualidade que transformaram nosso negócio. Não poderíamos estar mais felizes com seus serviços."
    },
    {
